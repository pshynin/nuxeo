...
/**
 * Load entries into a {@link org.nuxeo.ecm.directory.Directory} from a CSV File. Depending on duplicate management
 * policy, duplicate entries are ignored, updated or trigger an error.
 *
 * @since 11.1
 */
...
public class LoadFromCSV extends AbstractDirectoryOperation {
    ...
    public void run(Blob dataFile) {
        ...
        directoryService.loadFromCSV(directoryName, dataFile, dataLoadingPolicy);
    }
}
